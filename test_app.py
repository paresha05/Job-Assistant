...
def test_web_interface():
    ...
    try:
        response = requests.get("http://yourhost", timeout=10)
...
def test_environment_setup():
    ...
    if missing_keys:
        print(f"\n  Note: {len(missing_keys)} API keys not configured.")
...
def main():
    ...
    if passed == total:
        ...
        print("\n Next steps:")
        print("   1. Keep the app running and visit: http://yourhost")
